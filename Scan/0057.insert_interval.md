...
难度: Medium
标签: Array、Scan、Intervals

![57](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.32imyg5ot8.webp)
...
class Solution {
    public int[][] insert(int[][] intervals, int[] newInterval) {
        ...
        while (
            curIndex < n &&
            intervals[curIndex][1] < newInterval[0]
        ) {
        ...
        // Step 4: Add all remaining intervals after newInterval.
        while (curIndex < n) {
            res.add(intervals[curIndex]);
            curIndex++;
        }
