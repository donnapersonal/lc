...
难度: Medium
标签: String、Expand Around Center、Manacher's algorithm

![5](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.szmrx5u2y.webp)
...
class Solution {
    public String longestPalindrome(String s) {
        // Handle the empty string case immediately.
        if (s == null || s.isEmpty()) {
            return "";
        }

        // Track the inclusive boundaries of the longest
        ...
        for (int i = 0; i < s.length(); i++) {
            // Expand around one center.
            // This handles odd-length palindromes:
            // "a", "aba", "racecar".
            int[] odd = expand(s, i, i);

            // Expand around two adjacent centers.
            // This handles even-length palindromes:
            // "aa", "abba".
            ...
            int evenLeft = even[0];
            int evenRight = even[1];

            // If the odd-length palindrome is longer than
            // the current best result, update the boundaries.
            if (oddRight - oddLeft > end - start) {
                start = oddLeft;
                end = oddRight;
            }

            // Do the same for the even-length palindrome.
        ...
        // Java substring excludes the ending index,
        // so use end + 1 to include s[end].
        return s.substring(start, end + 1);
    }

    // Helper function that expands around the given center.
