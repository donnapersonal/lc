...
![19](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.96af218y6n.webp)
...
class Solution {
    public ListNode removeNthFromEnd(ListNode head, int n) {
        ...
        // This helps handle the case where we remove the original head.
        ListNode dummy = new ListNode(0);
        dummy.next = head;

        // Initialize two pointers from dummy.
        ListNode slow = dummy;
        ListNode fast = dummy;

        // Move fast n + 1 steps ahead.
        // This ensures slow will stop right before the node to delete.
        for (int i = 0; i < n + 1; i++) {
            fast = fast.next;
        }
