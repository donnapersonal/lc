...
![91](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.7i14bmxehp.webp)
...
class Solution {
    public int numDecodings(String s) {
        ...
        for (int i = 1; i < s.length(); i++) {
            ...
            // Case 1: current digit is decoded alone.
            if (s.charAt(i) != '0') {
                temp += cur;
            }

            // Case 2: previous digit and current digit are decoded together.
