...
![70](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.7p4ac1b0y6.webp)
...
class Solution {
    public int climbStairs(int n) {
        ...
        // Calculate the answer from stair 3 through stair n.
        for (int i = 3; i <= n; i++) {
            // Reach stair i either from i - 1 or i - 2.
