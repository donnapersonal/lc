...
![72](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.9gx96zzfbu.webp)
...
class Solution {
    public int minDistance(String word1, String word2) {
        ...
        // Base case:
        // converting empty word1 to word2.substring(0, j)
        ...
        for (int i = 1; i <= m; i++) {
            ...
            // converting word1.substring(0, i) to empty string
