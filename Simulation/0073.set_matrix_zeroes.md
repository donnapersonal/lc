...
![73](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.102u9x7kn4.webp)
...
class Solution {
    public void setZeroes(int[][] matrix) {
        ...
        // Check whether the first column originally has any zero.
        for (int i = 0; i < m; i++) {
            if (matrix[i][0] == 0) {
                firstColZero = true;
                break;
        ...
        // Check whether the first row originally has any zero.
        for (int j = 0; j < n; j++) {
            if (matrix[0][j] == 0) {
                firstRowZero = true;
                break;
