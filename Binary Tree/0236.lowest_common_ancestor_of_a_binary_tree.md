...
![236](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.5mohg8e0el.png)
...
class Solution {
    public TreeNode lowestCommonAncestor(TreeNode root, TreeNode p, TreeNode q) {
        // Base case 1:
        // If the current node is null, this subtree does not contain p or q.
        if (root == null) {
            return null;
        }
        ...
        // This also handles the case where one node is the ancestor of the other.
        if (root == p || root == q) {
            return root;
        }
        ...
        // If neither side contains p or q, return null.
        if (left == null && right == null) {
            return null;
        }
