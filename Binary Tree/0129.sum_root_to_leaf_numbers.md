...
![129](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.73umgsvmli.webp)
...
class Solution {
    ...
    private int dfs(TreeNode root, int prevTotal) {
        if (root == null) {
            return 0;
        }

        int total = prevTotal * 10 + root.val;
