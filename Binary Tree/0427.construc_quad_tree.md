...
难度: Medium
标签: Tree、Recursion、Divide & Conquer

![427](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.1lci6n9o5h.webp)
...
class Solution {
    ...
    private int getSum(int r0, int c0, int r1, int c1) {
        return prefix[r1][c1]
            - prefix[r1][c0]
            - prefix[r0][c1]
            + prefix[r0][c0];
    ...
    private Node dfs(int r0, int c0, int r1, int c1) {
