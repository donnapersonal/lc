...
难度: Medium
标签: Array、Hashing、PQ、Soring、Bucket Sort

![347](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.6wrfbgxnt1.webp)
...
class Solution {
    public int[] topKFrequent(int[] nums, int k) {
        ...
        // Map.Entry<Integer, Integer> 表示一组键值对：
        // key   → Integer
        // value → Integer
        // entry 表示 Map 中当前遍历到的一组 key-value 键值对
        // valToFreq.entrySet() 会返回 Map 中所有的键值对
