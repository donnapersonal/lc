...
![example](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.32i6pbapm2.webp)
...
class Solution {
    public int maxDistance(int[][] grid) {
        ...
        // Step 1: Add all land cells into the queue.
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                if (grid[i][j] == 1) {
        ...
        // Step 2: If the grid is all water or all land, return -1.
