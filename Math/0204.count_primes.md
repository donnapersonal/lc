...
class Solution {
    public int countPrimes(int n) {
        ...
        // isPrime[i] represents whether i is currently considered prime.
        ...
        // We only need to process base factors up to sqrt(n).
        // Use i * i < n instead of i <= Math.sqrt(n) to avoid repeated sqrt calls.
        for (int i = 2; i * i < n; i++) {
        ...
        // Count all numbers that remain prime.
        int count = 0;
