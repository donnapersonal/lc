...
class Solution:
    def restoreIpAddresses(self, s: str) -> List[str]:
        ...
        def backtrack(start: int) -> None:
            ...
            remaining_segments = 4 - len(track)
...
class Solution {
    ...
    private void backtrack(String s, int start, List<String> track, List<String> res) {
        int remainingChars = s.length() - start;
        int remainingSegments = 4 - track.size();
        ...
        for (int len = 1; len <= 3; len++) {
            ...
            track.add(part);
            backtrack(s, start + len, track, res);
