...
难度: Medium
标签: Subset、Backtracking

![78](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.lwg62h6k1.webp)
...
class Solution {
    ...
    private void backtrack(int[] nums, int start) {
        ...
        // Try choosing each possible next element.
        for (int i = start; i < nums.length; i++) {
            track.add(nums[i]);

            // Move forward to avoid reusing previous elements.
            backtrack(nums, i + 1);
