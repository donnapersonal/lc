...
难度: Medium
标签: Combinations、Backtracking

![39](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.7axuhwf2i9.webp)
...
class Solution {
    ...
    private void backtrack(int[] candidates, int remain, int start) {
        ...
        for (int i = start; i < candidates.length; i++) {
            ...
            // Use i instead of i + 1 because the same candidate can be reused.
