...
![51](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.2rvurv42he.webp)
...
class Solution {
    public List<List<String>> solveNQueens(int n) {
        ...
        dfs(0, n, queens, col, diag1, diag2, res);
    ...
    private void dfs(
        ...
        for (int c = 0; c < n; c++) {
            ...
            dfs(row + 1, n, queens, col, diag1, diag2, res);
