...
![52](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.8dxjsx9odn.webp)
...
```java
class Solution {
    // Counter to record the total number of valid board configurations.
    private int res;

    public int totalNQueens(int n) {
        res = 0;

        // col[c] == true means column c already has a queen.
        boolean[] col = new boolean[n];

        // diag1[r + c] == true means this main diagonal is occupied.
        // r + c range: 0 to 2n - 2
        boolean[] diag1 = new boolean[2 * n - 1];

        // diag2[r - c + n - 1] == true means this anti diagonal is occupied.
        // r - c can be negative, so we add n - 1 to make it a valid index.
        // range after offset: 0 to 2n - 2
    ...
    private void dfs(
        ...
        // Base case:
        // If r == n, it means we have successfully placed n queens.
        if (r == n) {
            res++;
            return;
        }
        ...
        for (int c = 0; c < n; c++) {
            ...
            // Check whether position (r, c) is safe:
            // 1. column c is not occupied
            // 2. main diagonal is not occupied
            // 3. anti diagonal is not occupied
