...
![224](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.41yq9x3o07.webp)
    ...
    public int calculate(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (Character.isDigit(ch)) {
                ...
                int previousSign = stack.removeLast();
                int previousResult = stack.removeLast();
