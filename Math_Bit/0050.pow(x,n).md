...
难度: Medium
标签: Math、Fast Exponentiation (快速幂)

![50](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.9kgv4laqkz.webp)
...
class Solution {
    public double myPow(double x, int n) {
        // Convert n to long before negating it.
        ...
        // Store the current power of x:
        // x, x^2, x^4, x^8, ...
        double currentProduct = x;

        // Process one binary bit of exponent per iteration.
        while (exponent > 0) {
            // If exponent is odd, include the current power.
            if (exponent % 2 == 1) {
                result *= currentProduct;
            }

            // Move from x^k to x^(2k).
