...
![172](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.3uviszyaki.webp)
...
class Solution {
    public int trailingZeroes(int n) {
        // Count the total number of factors of 5 in n!.
        int count = 0;

        // Repeatedly count multiples of 5, 25, 125, and so on.
        while (n >= 5) {
            n /= 5;
            count += n;
        }
