...
难度: Hard
标签: Array、Graph、Topological Sort

![269](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.6wrgo37pa8.webp)
...
class Solution {
    public String alienOrder(String[] words) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (char neighbor : graph.getOrDefault(c, new ArrayList<>())) {
