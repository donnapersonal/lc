...
class Solution {
    public boolean canPartitionKSubsets(int[] nums, int k) {
        ...
        // Start from the largest number because Java sorts ascending.
    ...
    private boolean backtrack(int[] nums, int index, int[] buckets, int target) {
        ...
        for (int i = 0; i < buckets.length; i++) {
            ...
            // If putting num into one empty bucket does not work,
            // putting it into another empty bucket is equivalent.
            if (buckets[i] == 0) {
                break;
            }
        }
