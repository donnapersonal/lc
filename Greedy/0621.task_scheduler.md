...
![621](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.7snxd6kpq7.webp)
...
class Solution {
    public int leastInterval(char[] tasks, int n) {
        ...
        // Build the cooldown-based skeleton.
        int minTime = (maxCount - 1) * (n + 1) + maxCountTasks;

        // The final answer must be at least the number of tasks.
        return Math.max(minTime, tasks.length);
    }
}
```
