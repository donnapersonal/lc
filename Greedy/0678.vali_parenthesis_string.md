...
难度: Medium
标签: Array、Stack、Greedy

![678](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.icu6w69l1.webp)
...
class Solution {
    public boolean checkValidString(String s) {
        ...
        for (char ch : s.toCharArray()) {
            ...
            // If even the maximum possible number of unmatched '(' is negative,
            // then this prefix has too many ')'.
            if (high < 0) {
                return false;
            }

            // The minimum possible unmatched '(' cannot be negative.
            low = Math.max(low, 0);
        }

        // If low == 0, there exists at least one valid interpretation.
        return low == 0;
    }
}
```
