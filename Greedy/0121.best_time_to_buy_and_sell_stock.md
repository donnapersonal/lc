...
![121](https://github.com/donnapersonal/picx-images-hosting/raw/master/image.et70zffd9.webp)
...
class Solution {
    public int maxProfit(int[] prices) {
        ...
        // Store the largest valid profit found so far.
        // Zero means we may choose not to make a transaction.
        int maxProfit = 0;

        // Process prices from left to right.
        for (int price : prices) {
            // Update the best buying price seen so far.
